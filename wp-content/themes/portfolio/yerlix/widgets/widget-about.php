...
class Aletheme_About_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'yer_about_widget', 
			'description' => __('A widget that displays a short information about you.', 'yerlix') 
		);
		...
		$control_ops = array(
			'width'		=> 500, 
			'height'	=> 450, 
			'id_base'	=> 'yer_about_widget' 
		);

		/* Create the widget. */
		$this->WP_Widget( 'yer_about_widget', __('Aletheme About Me', 'yerlix'), $widget_ops, $control_ops );
	}
